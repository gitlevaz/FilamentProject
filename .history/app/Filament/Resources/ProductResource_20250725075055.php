                        ...
                        FormAction::make('validate')
                            ...
                            ->action(function ($state, $livewire) {
                                try {
                                    ...
                                    //. Find Address (now using just the address field)
                                    $findResponse = Http::withHeaders([
                                        'Authorization' => "Bearer {$token}",
                                        'Accept' => 'application/json',
                                    ])->post('https://extranet.asmorphic.com/api/orders/findaddress', [
                                        'company_id' => 17,
                                        'street_name' => $state,   // ✅ Address field value used directly
                                        'suburb' => 'Melbourne',   // Hardcoded example, you can make these separate fields if needed
                                        'postcode' => '3000',
                                        'state' => 'VIC',
                                    ]);
